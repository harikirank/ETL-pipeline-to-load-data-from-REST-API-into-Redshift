...
weather_dyf = glueContext.create_dynamic_frame.from_options(
    ...
    format="csv",
    connection_options={
        "paths": [f"s3://analysis-weather-data/date={current_date}/weather_api_data.csv"],
        "recurse": True,
    },
...
redshift_output = glueContext.write_dynamic_frame.from_options(
    ...
    connection_options={
        "redshiftTmpDir": "s3://aws-glue-assets-102921461998-us-east-1/temporary/",
        "useConnectionProperties": "true",
        "aws_iam_role": "arn:aws:iam::102921461998:role/service-role/AmazonRedshift-CommandsAccessRole-20240321T190813",
        "dbtable": "public.weather_data",
        "connectionName": "RedshiftClusterConnection",
